	...
	return (
		<div className="h-full flex flex-col">
			<div className="px-5 pt-3 pb-2">
				<h5 className="font-medium">GitHub activity</h5>
...
GithubContributionsWidget.props = {
	noPadding: true,
	icon: (
		<div className="w-full h-full flex items-center justify-center rounded-full overflow-hidden bg-content text-canvas">
			<svg
				fill="currentColor"
				className="w-3.5"
				viewBox="0 0 24 24"
