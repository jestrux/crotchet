	...
	nav: () => [
		...
		},
		{
			...
			page: {
				title: "Projects",
				type: "list",
				resolve: () => window.dataSources.setHeroProjects.get(),
				entryAction: window.dataSources.setHeroProjects.entryAction,
				entryActions:
					window.dataSources.setHeroProjects.entryActions,
				// layoutProps: window.dataSources.setHeroProjects.layoutProps,
				action: () => ({
					label: "Project",
					icon: window.UI.svg("M12 4.5v15m7.5-7.5h-15", {
						strokeWidth: 3.5,
		...
		},
		{
			...
			page: {
				title: "Contacts",
				type: "list",
				resolve: () => window.dataSources.setHeroContacts.get(),
